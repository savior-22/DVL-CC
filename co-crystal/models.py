...
class GmpnnCSNetTwosides(GmpnnCSNetDrugBank):
    ...
    def forward(self, batch):
        ...
        #print(drug_data.xsmpretrain.shape)
        ...
        view1_shared = gen1(drug_data.x)
        d1 = dis1(view1_shared.detach())
        tx = dis1(drug_data.xsmpretrain)
        ...
        view2_shared = gen2(drug_data.xsmpretrain)
        d2 = dis1(view2_shared.detach())
        txsm = dis1(drug_data.x)
